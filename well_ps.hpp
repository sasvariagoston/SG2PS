...
void WELL_TXT (const vector <GDB>& inGDB, const vector <WELL_INTERVAL>& INT, const vector <WELL_FREQUENCY>& FREQ, ofstream& OTX, const double MIN_VAL, const double MAX_VAL, const double STEP);
